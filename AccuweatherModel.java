        ...
        switch (period) {
            ...
            case FIFE_DAYS:
               ...
               HttpUrl httpUrl5Days = new HttpUrl.Builder()
                ...
                String temperature1 = objectMapper.readTree(weatherResponse5Days).at("/DailyForecasts").get(0).at("/Temperature/Maximum/Value").asText();
                ...
                String temperature2 = objectMapper.readTree(weatherResponse5Days).at("/DailyForecasts").get(1).at("/Temperature/Maximum/Value").asText();
                ...
                String temperature3 = objectMapper.readTree(weatherResponse5Days).at("/DailyForecasts").get(2).at("/Temperature/Maximum/Value").asText();
                ...
                String temperature4 = objectMapper.readTree(weatherResponse5Days).at("/DailyForecasts").get(3).at("/Temperature/Maximum/Value").asText();
                ...
                String temperature5 = objectMapper.readTree(weatherResponse5Days).at("/DailyForecasts").get(4).at("/Temperature/Maximum/Value").asText();
